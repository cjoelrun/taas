...
class StrategyFactory(object):
    ...
    def create_strategy(self, strategy_name, execution_parameters):
        subclasses = self._all_subclasses(BaseStrategy)
        try:
            return self._get_next_subclass(subclasses, strategy_name)(self._parameters, execution_parameters)
